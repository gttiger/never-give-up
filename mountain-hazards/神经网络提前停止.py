...
result1=[]                                                        #"11", "12", "13", "14"]
for lu in range(3,13):
    result1 = []
    for tao in range(3,13):
        inputdimension = 1
        jiedian = lu
        jiedian2 = tao
        outputdimension = 4
        ...
        writer = tf.summary.FileWriter(r'E:\tensorflow\logs', sess.graph)
        ...
        print(result)
result.to_excel(r'E:\山地\排序\result1.xlsx')
